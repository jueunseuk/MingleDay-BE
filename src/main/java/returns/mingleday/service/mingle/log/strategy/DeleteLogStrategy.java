...
@Component
public class DeleteLogStrategy implements CreateMingleLogInterface {
    @Override
    public MingleLog create(Mingle mingle, MingleMember operator, Object target) {
        ...
        String content = operator.getDisplayName() + "님이 " + schedule.getTitle() + " 일정을 삭제했습니다.";
        ...
        return MingleLog.ofTarget(
                ...
                schedule.getTitle(),
                content,
                MingleLogType.DELETE
        );
    }

    @Override
    public MingleLogType getMingleLogType() {
        return MingleLogType.DELETE;
    }
}
